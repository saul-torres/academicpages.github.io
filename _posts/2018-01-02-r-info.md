...
## Básicos
  * R para profesionales de los datos: una introducción. Carlos J. Gil Bellosta. [_link_](https://www.datanalytics.com/libro_r/index.html)
...
### Estadística
  ...
  * Modeling and Solving Linear Programming with R. Pep Simo. [_link_](https://github.com/pepsimo/LinearProgramming)
...
### Análisis espacial
  ...
  * Geocomputation with R. Robin Lovelace. [_link_](https://geocompr.robinlovelace.net/)
